...
import { addPropertySchema, addDraftPropertySchema, updateDraftPropertySchema, changeStatus as changeStatusSchema, updatePropertySchema, filterPropertiesSchema, searchPropertiesSchema } from "../../validators/property.validators";
...
router.put("/draft/:id", authMiddleware, validate(updateDraftPropertySchema), updateDraftProperty); //updates draft property - save progress
